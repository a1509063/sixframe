...
function(e) {
	...
	H.prototype.pullData = function(e, i) {
		...
		if (n.url) {
			var access_token = localStorage.getItem('access_token');//获取token
			var c = {};
			c[o.pageName] = e,
	...
	H.prototype.events = function() {
		...
		function() {
			...
			if (!e.data("off")) {
				...
				Math.round(i.prop("scrollWidth")) > Math.round(i.outerWidth()) && (a.tipsIndex = l.tips(['<div class="layui-table-tips-main" style="margin-top: -' + (i.height() + 16) + "px;" +
				function() {
